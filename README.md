...
**v1.2.1**: 全面切换 GoZ binary 中转（原生携带 PolyGroup/Mask/UV），Python + ZScript 双版本统一。
...
**v1.2.1**: Fully migrated to GoZ binary pipeline (native PolyGroup/Mask/UV), Python + ZScript unified.
